    ...
    with open(Path("crosswords", "guardian.ldjson"), "a") as f:
        for page_number in itertools.count(start=265):
            ...
            response = requests.get(
                f"https://www.theguardian.com/crosswords/series/cryptic?page={page_number}", allow_redirects=False
            )
            ...
            crossword_links = set(
                ...
                if x.get("href") and x.get("href").startswith("https://www.theguardian.com/crosswords/cryptic/")
            )
